  ...
  <div class="container mx-auto px-6 py-12 max-w-full">
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
      ...
      <DashboardStat 
        title="Total Grants"
        :value="totalGrants"
        description="All grants ever added"
      />
...
/* donors API returns { success, data: [] } */
const donorsArray = donorsRes?.data || [];

const totalDonors = donorsArray.length.toLocaleString();

/* ---- 3. Get GRANTS ---- */
const grantsRes = await $fetch("/api/grants");
/* grants API returns { success, data: [] } */
...
const DonationCardProps = {
  ...
  buttons: [
...

    {
      ...
      paths: ["M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2","M16 3.128a4 4 0 0 1 0 7.744","M22 21v-2a4 4 0 0 0-3-3.87"],
      circles: [["9","7","4"]],
      accessLevel: 0
    }
  ]
