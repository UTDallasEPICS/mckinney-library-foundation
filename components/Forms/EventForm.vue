<template>
	<div class="bg-[#e5e9ec] p-0 gap-0 border-0 rounded-md">
		<VeeForm v-slot="{ submitCount }" :initial-values="initValues" :validation-schema="schema" class="w-full max-w-3xl max-h-[80vh] overflow-y-auto mx-auto" @submit="submitEvent">
